...
export const PRODUCTS: Record<string, Product> = {
  ...
  individual: {
    ...
    priceSub: '+ $99 per person, per direction — charged only once we confirm a bookable seat.',
    tagline: 'Pay the fee only if we find a real seat.',
    description:
  ...
  human: {
    ...
    price: '$99.99',
    priceUnit: '/ month',
    tagline: 'A real person checks your routes — 99.99% phantom-flight-proof.',
    description:

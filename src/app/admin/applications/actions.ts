    ...
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;">
        ...
        <tr><td style="padding-bottom:32px;text-align:center;">
          <p style="margin:0;font-size:10px;letter-spacing:4px;text-transform:uppercase;color:#E8963A;font-family:'Courier New',monospace;">THE FLIGHTS CLUB</p>
        </td></tr>
        ...
        <tr><td style="background-color:#0E1220;border:1px solid #1E2538;border-radius:16px;padding:40px 36px;">
          ...
          <p style="margin:0 0 28px;font-size:15px;color:#9DA3B4;line-height:1.6;">
            ...
            has been approved. You're one step away from joining The Flights Club.
          </p>
          ...
          <p style="margin:0;font-size:13px;color:#9DA3B4;line-height:1.6;">
            ...
            <strong style="color:#F5F5F0;">The Flights Club Team</strong><br />
            <a href="mailto:hello@theflightsclub.com.au" style="color:#E8963A;text-decoration:none;">hello@theflightsclub.com.au</a>
          </p>

        </td></tr>

        <tr><td style="padding-top:24px;text-align:center;">
          <p style="margin:0;font-size:11px;color:#5C6378;">© 2025 The Flights Club by iFLYflat · Australia</p>
        </td></tr>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;">
        ...
        <tr><td style="background-color:#0E1220;border:1px solid #1E2538;border-radius:16px;padding:40px 36px;">
          ...
          <p style="margin:0 0 24px;font-size:15px;color:#9DA3B4;line-height:1.6;">
            Thank you for your interest in The Flights Club. After reviewing your application,
...
export async function approveApplication(
  ...
  const { error: emailError } = await resend.emails.send({
    ...
    to:      customerEmail,
    subject: 'Your Flights Club membership is ready — complete your enrolment',
...
export async function rejectApplication(
  ...
  const { error: emailError } = await resend.emails.send({
    from:    'The Flights Club <hello@theflightsclub.com.au>',
    to:      customerEmail,
    subject: 'Your Flights Club application — an update',

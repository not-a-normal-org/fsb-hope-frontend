      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 lg:px-16 py-20 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-6xl xl:text-7xl font-bold text-text-primary mb-6 leading-tight tracking-tight flex flex-wrap justify-start gap-2 sm:gap-3">
              ...
              {line2Words.map((word, idx) => (
                <motion.span
                  ...
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: (line1Words.length + idx) * 0.05, duration: 0.5, ease: 'easeOut' }}
                >
                  {word}
                </motion.span>
              ))}
